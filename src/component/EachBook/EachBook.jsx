...
export default function EachBook({ book }) {
    ...
    return (
        <Link to={`/book-details/${bookId}`}><div className='border-2 max-w-94 h-[480p] border-gray-100 rounded-lg p-4 shadow-md shadow-gray-200'>
            <div className='py-6 px-24 bg-gray-200 rounded-2xl flex justify-center items-center'>
                <img className='h-44 w-30' src={image} />
            </div>
